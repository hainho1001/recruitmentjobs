...
@section('content')
	<div class="login__top-header">
        <a class="navbar-brand header__logo" href="{{url('/')}}">HongNhung</a>
    </div>
    <div class="login-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content login-modal__content">
                <div class="modal-header">
                    <h5 class="modal-title login-modal__title" id="exampleModalLabel">Đăng Ký Thành Viên</h5>
                </div>
                <div class="modal-body">
                    <div class="login-modal__row row">
                        <div class="col-6">
                            <a class="login-modal__btn d-flex align-items-center justify-content-center" href="">
                                <span class="login-modal__icon">
                                ...
                                <span class="login-modal__btn__span d-none d-lg-block">Dùng tài khoản</span>
                                <span class="login-modal__btn__span">Google</span>
                            </a>
                        </div>
                        <div class="col-6">
                            <a class="login-modal__btn d-flex align-items-center justify-content-center" href="">
                                ...
                                <span class="login-modal__btn__span d-none d-lg-block">Dùng tài khoản</span>
                                <span class="login-modal__btn__span">Facebook</span>
                            </a>
                        </div>
                    </div>
                    <div class="login-modal__user-email">ĐĂNG KÝ BẰNG EMAIL</div>
                    <!-- Sign In Form -->
                    {!! Form::open(['method'=>'POST', 'route'=>'register']) !!}
                        ...
                        {!!Form::text('roles', '0', ['class'=>'input-control', 'style' => 'display:none'])!!}
                        <div class="mb-4">
                            {!!Form::label('Email')!!}
                        ...
                        <div class="mb-4">
                            ...
                            {!!Form::password('password_confirmation', ['class'=>'input-control' ])!!}                            
                        </div>
                        <button class="btn-red">Đăng ký</button>
                    {!!Form::close()!!}
                    <div class="text-center login-modal__register">Bạn là thành viên HongNhung? <a href="{{route('login')}}">Đăng nhập</a></div>
                </div>
            </div>
        </div>
    </div>
