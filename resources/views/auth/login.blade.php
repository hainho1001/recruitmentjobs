        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content login-modal__content">
                <div class="modal-header">
                    <h5 class="modal-title login-modal__title" id="exampleModalLabel">Đăng Nhập</h5>
                </div>
                <div class="modal-body">
                    ...
                    <div class="login-modal__user-email">Sử dụng tài khoản</div>

                    @if(session('status'))
                        <ul>
                            <li class="alert alert-danger text-center">{{session('status')}}</li>                            
                        </ul>
                    @endif
                    <!-- Sign In Form -->
                    {!! Form::open(['method' => 'POST', 'route' => 'login']) !!}
                        ...
                        {!!Form::submit('Đăng Nhập', ['class' => 'btn-red']) !!}
                    {!! Form::close() !!}
                    <hr class="login-modal__light">
                    <div class="text-center login-modal__register">Chưa có tài khoản? <a href="{{route('register')}}">Đăng ký!</a></div>
                </div>
            </div>
        </div>
    </div>
